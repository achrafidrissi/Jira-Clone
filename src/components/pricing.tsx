    ...
    <section className="overflow-hidden bg-slate-50" id="pricing">
      <div className="mx-auto max-w-5xl px-8 py-24">
        <div className="mb-20 flex w-full flex-col text-center">
          ...
          Save valuable time in planning, automate your processes, and optimize collaboration. Focus on what matters most while AI handles the rest. Get started in minutes.
          </div>
        </div>
        <div className="relative flex flex-col items-stretch justify-center gap-8 lg:flex-row">
          <PricingCard
            ...
            originalPrice={0}
            features={[
              <span key="feature1">1 AI-generated recommendation per day</span>,
              <span key="feature2">Basic customization options</span>,
              <span key="feature3">Email support</span>,
            ]}
            buttonLink="/sign-up"
            description="Ideal for discovering the power of our AI"
          />
          <PricingCard
            key="Pro Plan"
            title="Offre Pro"
            ...
            originalPrice={30}
            features={[
              <span key="feature1">Unlimited AI-generated recommendations</span>,
              <span key="feature2">Access to AWS Forecast</span>,
            ...
            description="For teams that want to unlock the full potential of AI"
          />
        </div>
        <TestimonialSingle
          testimonial={{
            ...
            content:
              "Cette plateforme a révolutionné notre gestion de projet ! Je gagne des heures chaque semaine, et mon équipe travaille plus efficacement grâce à des automatisations intelligentes.",
      ...
      >
        <div className="flex h-full flex-col gap-5 rounded-lg bg-white p-8 lg:gap-8">
          ...
          <div className="space-y-2">
            <Button href="/role-selection" color="blue" className="w-full">
              Get SmartSprint
            </Button>
          </div>
        </div>
