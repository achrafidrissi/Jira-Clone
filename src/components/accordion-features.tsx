...
const features = [
  {
    ...
    description:
      "No more complex briefs! Our AI transforms simple ideas into detailed requirements. Describe your project in a few words and get user stories, an estimated budget, a recommended team size, and more.",
    additionalInfo: [
      "Quick and intuitive requirement definition",
      "Automatic generation of detailed specifications",
      "Validation and direct submission to the Product Owner",
    ],
    icons: [
      <svg
        key="clock"
  ...
  },
  {
    ...
    description:
      "Our AI analyzes task history and importance to predict your project's completion. Powered by AWS Forecast, track your progress in real time and anticipate deadlines.",
    additionalInfo: [
      "Analysis of past data and estimated progression",
      "Accurate performance indicators",
      "Automatic prediction of completion date",
    ],
    icons: [
      <svg
        key="click"
  ...
  {
    id: 3,
    title: "Workflow Automation & Issue Resolution",
    description:
      "Your workflow is fully automated. If a problem occurs, our AI evaluates its impact and acts accordingly!",
    additionalInfo: [
      "Automatic resolution of minor incidents",
      "Immediate alert for critical issues",
      "Notification to relevant members and the Product Owner",
    ],
    icons: [
      <svg
        key="edit"
  ...
  return (
    ...
    >
      <div className="px-8">
        ...
        Une gestion de projet assistée par IA <br />
      ...
      <TestimonialSingle
        testimonial={{
          name: "EL AIDI IDRISSI ACHRAF",
          content:
            "This project management platform is a game-changer! Its AI is incredibly intuitive and has allowed me to structure my projects in record time. My team collaborates more efficiently than ever.",
