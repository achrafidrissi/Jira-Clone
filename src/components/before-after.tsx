          ...
          <div className="rounded-2xl bg-white shadow-lg ring-2 ring-inset ring-slate-200">
            <div className="p-8 sm:p-12">
              ...
              <h3 className="font-display mt-4 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">
                Inefficient Traditional Project Management
              </h3>
              <ul className="mt-6 space-y-3 text-base text-slate-600 sm:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Lack of collaboration and real-time communication
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Manual task tracking slowing down workflows
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Time-consuming and inefficient repetitive tasks
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Difficulty in evaluating productivity and workload
                </li>
              </ul>
            </div>
          </div>
          <div className="rounded-2xl bg-blue-500 shadow-lg ring-1 ring-inset ring-blue-400">
            <div className="p-8 sm:p-12">
              ...
              <h3 className="font-display mt-4 text-2xl font-bold tracking-tight text-white sm:text-3xl">
                An Intelligent Assistant That Transforms Project Management
              </h3>
              <ul className="mt-6 space-y-3 text-base text-white sm:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Personalized management experiences tailored to each team’s needs
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  AI-generated action plans and recommendations
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Automated evaluation and instant feedback for collaborators
                </li>
              </ul>
            </div>
          </div>
